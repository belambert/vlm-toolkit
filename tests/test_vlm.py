...
def test_prepare_vlm_batch_skips_corrupted(processor, tmp_images):
...
def test_prepare_vlm_batch_all_corrupted(processor, tmp_path):
...
def test_prepare_vlm_batch_respects_max_dim(processor, tmp_path):
    p = tmp_path / "big.png"
